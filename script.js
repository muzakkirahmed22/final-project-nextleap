...
! function(t) {
    ...
    "use strict";
    var e, i;
    t.fn.ratingLocales = {}, t.fn.ratingThemes = {}, e = {
        NAMESPACE: ".rating",
        DEFAULT_MIN: 0,
        DEFAULT_MAX: 5,
        DEFAULT_STEP: .5,
        ...
        _parseValue: function(t) {
            var e = parseFloat(t);
            return isNaN(e) && (e = this.clearValue), !this.zeroAsNull || 0 !== e && "0" !== e ? e : null
        },
        ...
        _initSlider: function(t) {
            ...
            this.initialValue = e.isEmpty(i) ? 0 : i, this._setDefault("min", this._parseAttr("min", t)), this._setDefault("max", this._parseAttr("max", t)), this._setDefault("step", this._parseAttr("step", t)), (isNaN(this.min) || e.isEmpty(this.min)) && (this.min = e.DEFAULT_MIN), (isNaN(this.max) || e.isEmpty(this.max)) && (this.max = e.DEFAULT_MAX), (isNaN(this.step) || e.isEmpty(this.step) || 0 === this.step) && (this.step = e.DEFAULT_STEP), this.diff = this.max - this.min
        },
        _initHighlight: function(t) {
            var e, i = this._getCaption();
            t || (t = this.$element.val()), e = this.getWidthFromValue(t) + "%", this.$filledStars.width(e), this.cache = {
                caption: i,
                width: e,
                val: t
            }
        ...
        _getContainerCss: function() {
            return "rating-container" + e.getCss(this.theme, "theme-" + this.theme) + e.getCss(this.rtl, "rating-rtl") + e.getCss(this.size, "rating-" + this.size) + e.getCss(this.animate, "rating-animate") + e.getCss(this.disabled || this.readonly, "rating-disabled") + e.getCss(this.containerClass, this.containerClass) + (this.displayOnly ? " is-display-only" : "")
        },
        _checkDisabled: function() {
            var t = this.$element,
                e = this.options;
            this.disabled = void 0 === e.disabled ? t.attr("disabled") || !1 : e.disabled, this.readonly = void 0 === e.readonly ? t.attr("readonly") || !1 : e.readonly, this.inactive = this.disabled || this.readonly, t.attr({
        ...
        _addContent: function(t, e) {
            var i = this.$container,
                a = "clear" === t;
            return this.rtl ? a ? i.append(e) : i.prepend(e) : a ? i.prepend(e) : i.append(e)
        },
        _generateRating: function() {
            var i, a, n, s = this.$element;
            a = this.$container = t(document.createElement("div")).insertBefore(s), e.addCss(a, this._getContainerCss()), this.$rating = i = t(document.createElement("div")).attr("class", "rating-stars").appendTo(a).append(this._getStars("empty")).append(this._getStars("filled")), this.$emptyStars = i.find(".empty-stars"), this.$filledStars = i.find(".filled-stars"), this._renderCaption(), this._renderClear(), this._initHighlight(), this._initCaptionTitle(), a.append(s), this.rtl && (n = Math.max(this.$emptyStars.outerWidth(), this.$filledStars.outerWidth()), this.$emptyStars.width(n)), s.appendTo(i)
        },
        ...
        _renderCaption: function() {
            ...
            if (this.showCaption) {
                if (i = this.fetchCaption(a), n && n.length) return e.addCss(n, "caption"), n.html(i), void(this.$caption = n);
                this._addContent("caption", '<div class="caption">' + i + "</div>"), this.$caption = this.$container.find(".caption")
            }
        },
        _renderClear: function() {
            var i, a = this.clearElement ? t(this.clearElement) : "";
            if (this.showClear) {
                if (i = this._getClearClass(), a.length) return e.addCss(a, i), a.attr({
                    title: this.clearButtonTitle
                }).html(this.clearButton), void(this.$clear = a);
                this._addContent("clear", '<div class="' + i + '" title="' + this.clearButtonTitle + '">' + this.clearButton + "</div>"), this.$clear = this.$container.find("." + this.clearButtonBaseClass)
            }
        },
        ...
        _toggleHover: function(t) {
            var e, i, a;
            t && (this.hoverChangeStars && (e = this.getWidthFromValue(this.clearValue), i = t.val <= this.clearValue ? e + "%" : t.width, this.$filledStars.css("width", i)), this.hoverChangeCaption && (a = t.val <= this.clearValue ? this.fetchCaption(this.clearValue) : t.caption) && this._setCaption(a + ""))
        },
        _init: function(e) {
            var i, a = this,
                n = a.$element.addClass("rating-input");
            return a.options = e, t.each(e, function(t, e) {
                a[t] = e
            }), (a.rtl || "rtl" === n.attr("dir")) && (a.rtl = !0, n.attr("dir", "rtl")), a.starClicked = !1, a.clearClicked = !1, a._initSlider(e), a._checkDisabled(), a.displayOnly && (a.inactive = !0, a.showClear = !1, a.showCaption = !1), a._generateRating(), a._initEvents(), a._listen(), i = a._parseValue(n.val()), n.val(i), n.removeClass("rating-loading")
        },
        _initCaptionTitle: function() {
            var e;
            this.showCaptionAsTitle && (e = this.fetchCaption(this.$element.val()), this.$rating.attr("title", t(e).text()))
        },
        _trigChange: function(t) {
            this._initCaptionTitle(), this.$element.trigger("change").trigger("rating:change", t)
        },
        _initEvents: function() {
            ...
            t.events = {
                ...
                initTouch: function(i) {
                    var a, n, s, r, l, o, h, c, u = t.clearValue || 0;
                    ("ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch) && !t.inactive && (a = i.originalEvent, n = e.isEmpty(a.touches) ? a.changedTouches : a.touches, s = t.events._getTouchPosition(n[0]), "touchend" === i.type ? (t._setStars(s), c = [t.$element.val(), t._getCaption()], t._trigChange(c), t.starClicked = !0) : (l = (r = t.calculate(s)).val <= u ? t.fetchCaption(u) : r.caption, o = t.getWidthFromValue(u), h = r.val <= u ? o + "%" : r.width, t._setCaption(l), t.$filledStars.css("width", h)))
                },
                starClick: function(e) {
                    var i, a;
                    t.events._listenClick(e, function(e) {
                        if (t.inactive) return !1;
                        i = t.events._getTouchPosition(e), t._setStars(i), a = [t.$element.val(), t._getCaption()], t._trigChange(a), t.starClicked = !0
                    })
                },
                ...
                starMouseMove: function(e) {
                    var i, a;
                    t.events._noMouseAction(e) || (t.starClicked = !1, i = t.events._getTouchPosition(e), a = t.calculate(i), t._toggleHover(a), t.$element.trigger("rating:hover", [a.val, a.caption, "stars"]))
                },
                starMouseLeave: function(e) {
                    var i;
                    t.events._noMouseAction(e) || t.starClicked || (i = t.cache, t._toggleHover(i), t.$element.trigger("rating:hoverleave", ["stars"]))
                },
                clearMouseMove: function(e) {
                    var i, a, n;
                    !t.events._noMouseAction(e) && t.hoverOnClear && (t.clearClicked = !1, i = '<span class="' + t.clearCaptionClass + '">' + t.clearCaption + "</span>", a = t.clearValue, n = {
                        caption: i,
                        width: t.getWidthFromValue(a) || 0,
                        val: a
                    }, t._toggleHover(n), t.$element.trigger("rating:hover", [a, i, "clear"]))
                },
        ...
        _listen: function() {
            var i = this.$element,
                ...
                s = this.$clear,
                r = this.events;
            return e.handler(n, "touchstart touchmove touchend", t.proxy(r.initTouch, this)), e.handler(n, "click touchstart", t.proxy(r.starClick, this)), e.handler(n, "mousemove", t.proxy(r.starMouseMove, this)), e.handler(n, "mouseleave", t.proxy(r.starMouseLeave, this)), this.showClear && s.length && (e.handler(s, "click touchstart", t.proxy(r.clearClick, this)), e.handler(s, "mousemove", t.proxy(r.clearMouseMove, this)), e.handler(s, "mouseleave", t.proxy(r.clearMouseLeave, this))), a.length && e.handler(a, "reset", t.proxy(r.resetForm, this), !0), i
        },
        _getStars: function(t) {
            var e, i = '<span class="' + t + '-stars">';
            for (e = 1; e <= this.stars; e++) i += '<span class="star">' + this[t + "Star"] + "</span>";
            return i + "</span>"
        },
        _setStars: function(t) {
            ...
            return i.val(a), this.$filledStars.css("width", e.width), this._setCaption(e.caption), this.cache = e, i
        },
        ...
        getValueFromPosition: function(t) {
            var i, a, n = e.getDecimalPlaces(this.step),
                s = this.$rating.width();
            return a = this.diff * t / (s * this.step), a = this.rtl ? Math.floor(a) : Math.ceil(a), i = e.applyPrecision(parseFloat(this.min + a * this.step), n), i = Math.max(Math.min(i, this.max), this.min), this.rtl ? this.max - i : i
        },
        getWidthFromValue: function(t) {
            var e, i, a = this.min,
                n = this.max,
                s = this.$emptyStars;
            return !t || t <= a || a === n ? 0 : (e = (i = s.outerWidth()) ? s.width() / i : 1, t >= n ? 100 : (t - a) * e * 100 / (n - a))
        },
        fetchCaption: function(t) {
            var i, a, n, s = parseFloat(t) || this.clearValue,
                r = this.starCaptions,
                l = this.starCaptionClasses;
            return s && s !== this.clearValue && (s = e.applyPrecision(s, e.getDecimalPlaces(this.step))), n = "function" == typeof l ? l(s) : l[s], a = "function" == typeof r ? r(s) : r[s], i = e.isEmpty(a) ? this.defaultCaption.replace(/\{rating}/g, s) : a, '<span class="' + (e.isEmpty(n) ? this.clearCaptionClass : n) + '">' + (s === this.clearValue ? this.clearCaption : i) + "</span>"
        },
        destroy: function() {
            var i = this.$element;
            return e.isEmpty(this.$container) || this.$container.before(i).remove(), t.removeData(i.get(0)), i.off("rating").removeClass("rating rating-input")
        },
        create: function(t) {
        ...
        clear: function() {
            var t = '<span class="' + this.clearCaptionClass + '">' + this.clearCaption + "</span>";
            return this.inactive || this._setCaption(t), this.showStars(this.clearValue).trigger("change").trigger("rating:clear")
        },
        reset: function() {
        ...
        refresh: function(e) {
            var i = this.$element;
            return e ? this.destroy().rating(t.extend(!0, this.options, e)).trigger("rating:refresh") : i
        }
        ...
        switch (n.shift(), this.each(function() {
            var r, l = t(this),
                ...
                d = {},
                p = {};
            o || (c && (d = t.fn.ratingThemes[c] || {}), "en" === u || e.isEmpty(t.fn.ratingLocales[u]) || (p = t.fn.ratingLocales[u]), r = t.extend(!0, {}, t.fn.rating.defaults, d, t.fn.ratingLocales.en, p, h, l.data()), o = new i(this, r), l.data("rating", o)), "string" == typeof a && s.push(o[a].apply(o, n))
        }), s.length) {
            case 0:
                return this;
            case 1:
...
! function(t) {
    ...
    t[o] && t[o].version > r || (t[o] = function(t, e) {
        ...
        _truncateToWord: function(t) {
            for (var e = t, i = this, n = this.__getTextContent(e), s = -1 !== n.indexOf(" ") ? " " : "　", o = n.split(s), r = "", h = o.length; h >= 0; h--)
...
! function(t) {
    ...
    h.extend(h.timeago, {
        ...
        inWords: function(n) {
            ...
            function l(t, e) {
                var a = h.isFunction(t) ? t(e, n) : t,
                    i = r.numbers && r.numbers[e] || e;
                return a.replace(/%d/i, i)
            }
            var m = a < 45 && l(r.seconds, Math.round(a)) || a < 90 && l(r.minute, 1) || i < 45 && l(r.minutes, Math.round(i)) || i < 90 && l(r.hour, 1) || o < 24 && l(r.hours, Math.round(o)) || o < 42 && l(r.day, 1) || s < 30 && l(r.days, Math.round(s)) || s < 45 && l(r.month, 1) || s < 365 && l(r.months, Math.round(s / 30)) || u < 1.5 && l(r.year, 1) || l(r.years, Math.round(u)),
                d = r.wordSeparator || "";
            return void 0 === r.wordSeparator && (d = " "), h.trim([t, m, e].join(d))
        },
        parse: function(t) {
            var e = h.trim(t);
        ...
        datetime: function(t) {
            var e = a.isTime(t) ? h(t).attr("datetime") : h(t).attr("title");
            return a.parse(e)
        },
        isTime: function(t) {
    ...
    var i = {
        ...
        update: function(t) {
            var e = t instanceof Date ? t : a.parse(t);
            h(this).data("timeago", {
                datetime: e
            }), a.settings.localeTitle && h(this).attr("title", e.toLocaleString()), n.apply(this)
        },
        updateFromDOM: function() {
            h(this).data("timeago", {
                datetime: a.parse(a.isTime(this) ? h(this).attr("datetime") : h(this).attr("title"))
            }), n.apply(this)
        },
        dispose: function() {
    ...
    function n() {
        ...
        var e = function(t) {
            if (!(t = h(t)).data("timeago")) {
                ...
                var e = h.trim(t.text());
                a.settings.localeTitle ? t.attr("title", t.data("timeago").datetime.toLocaleString()) : !(0 < e.length) || a.isTime(t) && t.attr("title") || t.attr("title", e)
            }
            return t.removeClass("initial").addClass("loaded").data("timeago")
        }(this);
...
function openVideoPlayer(w, h, video_key, video_title) {
    ...
    $('#video_popup').parent().parent().find('.k-window').css({
        'background-color': '#000',
        'border-color': '#000'
    });
    $('#video_popup').parent().find('.k-window-content').css({
        'padding': '0',
        'margin': '0',
        'background-color': '#000',
        'overflow': 'hidden'
    });
    $('#video_popup').parent().find('.k-window-titlebar').css({
        'background-color': '#000',
        'border-color': '#000',
        'color': '#fff'
    });
...
! function(n, e) {
    ...
    t.configure = function(n) {
        ...
        return u.offsetWidth, o(function(e) {
            "" === r.positionUsing && (r.positionUsing = t.getPositioningCSS()), a(c, function(n, e, t) {
                ...
                return i.transition = "all " + e + "ms " + t, i
            }(n, l, f)), 1 === n ? (a(u, {
                transition: "none",
                opacity: 1
        ...
        var e = t.status;
        return e ? e > 1 ? void 0 : ("number" != typeof n && (n = e >= 0 && e < .2 ? .1 : e >= .2 && e < .5 ? .04 : e >= .5 && e < .8 ? .02 : e >= .8 && e < .99 ? .005 : 0), e = i(e + n, 0, .994), t.set(e)) : t.start()
    }, t.trickle = function() {
        return t.inc()
        ...
        }), r.showSpinner || (i = e.querySelector(r.spinnerSelector)) && d(i), l != document.body && c(l, "nprogress-custom-parent"), l.appendChild(e), e
    }, t.remove = function() {
    ...
    function l(n, e) {
        var t, r = f(n);
        u(n, e) && (t = r.replace(" " + e + " ", " "), n.className = t.substring(1, t.length - 1))
    }
